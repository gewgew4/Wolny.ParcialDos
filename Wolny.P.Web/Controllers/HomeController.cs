...
public class HomeController(IHttpClientFactory httpClientFactory, ILogger<HomeController> logger) : Controller
{
    ...
    /// <summary>
    /// Con esto hago todas las llamadas http a la api
    /// </summary>
    /// <typeparam name="T">Tipo de clase esperada</typeparam>
    /// <param name="httpClientFactory">HTTP client por DI</param>
    /// <param name="url">URL donde se hace la llamada</param>
    /// <param name="method">Verbo HTTP</param>
    /// <param name="contentSend">Opcional, contenido del body</param>
    /// <returns>Objetos de clase especificada en T</returns>
